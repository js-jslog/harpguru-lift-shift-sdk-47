import { withTiming, Easing, useSharedValue, useDerivedValue, interpolate } from 'react-native-reanimated'
...
export const useFlashAnimationValues = (
  ...
  useDerivedValue(() => {
    messageOpacity.value = interpolate(timingValue.value, [0, 1], [0, overlayOpacity])
