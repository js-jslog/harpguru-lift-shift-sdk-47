...
- MAJOR: Split this package out from harpstrata to make dedicated package for modelling covariance
- MINOR: Added unused `getCovarianceSeries` function from package in harpguru-core
